          ...
          <div className="column-group">
            <div className="column-left">
              ...
              <div>
                ...
                <input
                  className="filter-input-filed"
                  type="text"
                  key="fatherName"
                  id="fatherName"
                  name="advance-filter-filed"
                />
              </div>
              <div>
...
AdvanceFilter.propTypes = {
  advanceFilterIsOpen: PropTypes.bool,
  closeAdvanceFilter: PropTypes.func,
};
