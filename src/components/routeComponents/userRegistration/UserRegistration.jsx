...
class UserRegistration extends Component {
  ...
  handleSubmit = () => {
    if (!this.state.hasError) {
      const data = {
        ...this.state.formData,
        registrationStatus: this.state.userSelected.registrationStatus !== 'REG'
          ? this.state.userSelected.registrationStatus : 'REG',
      ...
      if (this.props.searchData.mode === 'Edit') {
        if (this.isDataChanged()) {
          ...
          // Patch
          this.props.patchUserAction({ registrationStatus: this.state.userSelected.registrationStatus !== 'REG'
            ? this.state.userSelected.registrationStatus : 'REG' }, this.state.userSelected.id);
        }
      } else {
        // Create New Student
