...
InvalidCoordinatorPopUp.propTypes = {
  constants: PropTypes.object,
  redirectToPreviousLocation: PropTypes.func,
};

InvalidCoordinatorPopUp.defaultProps = {
  constants: {},
  redirectToPreviousLocation: () => {},
};
...
export default connect(mapStateToProps, null)(InvalidCoordinatorPopUp);
