 ...
 * @type {Class}
 */
class DefaultSplashPage extends Component {
  constructor(props) {
    super(props);
      ...
      <ContainerStyled width="100%">
        ...
        >
          <Col>
            ...
            <LoginForm
              isMemberSearch={isMemberSearch}
              setMemberSearchRoutFlag={this.setMemberSearchRoutFlag}
              admin={admin}
              config={config}
...
DefaultSplashPage.defaultProps = {
  config: {},
  constants: {},
  isAdminLogin: false,
  fetchMemberData: () => {},
